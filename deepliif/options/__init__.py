...
class Options:
    def __init__(self, d_params=None, path_file=None, mode='train'):
        ...
        self.loss_G_weights = [1 / self.modalities_no] * self.modalities_no if not hasattr(self,'loss_weights_g') else self.loss_weights_g
        self.loss_D_weights = [1 / self.modalities_no] * self.modalities_no if not hasattr(self,'loss_weights_d') else self.loss_weights_d
