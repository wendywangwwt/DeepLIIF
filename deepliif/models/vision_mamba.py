# adapted from https://github.com/ziyangwang007/Mamba-UNet/tree/main
...
from .mambaunet_config import get_config_default
...
class MambaUnet(nn.Module):
    def __init__(self, config=None, img_size=224, num_classes=21843, zero_head=False, vis=False,
        ...
        self.mamba_unet =  VSSM(
                                patch_size=4,#config.tile_size,#config.MODEL.VSSM.PATCH_SIZE,
                                in_chans=input_nc,#config.MODEL.VSSM.IN_CHANS,
                                num_classes=output_nc,#self.num_classes,
