...
MODEL_INFO = {'latest':{'model':'DeepLIIF', # cli.py train looks for subfolder "train" under dataroot
                        ...
                        'dir_output_standard_testpy':['Datasets_standard/Sample_Dataset/test'],
                        'dir_output_standard_inference':['Datasets_standard/Sample_Dataset/test_cli'],
              ...
              'ext':{'model':'DeepLIIFExt',
                     ...
                     'dir_output_standard_testpy':['Datasets_standard/Sample_Dataset_ext_withseg/test','Datasets_standard/Sample_Dataset_ext_noseg/test'],
                     'dir_output_standard_inference':['Datasets_standard/Sample_Dataset_ext_withseg/test_cli','Datasets_standard/Sample_Dataset_ext_noseg/test_cli'],
              ...
              'sdg':{'model':'SDG',
                     ...
                     'dir_output_standard_testpy':['Datasets_standard/Sample_Dataset_sdg/test'],
                     'dir_output_standard_inference':['Datasets_standard/Sample_Dataset_sdg/test_cli'],
              ...
              'cyclegan':{'model':'CycleGAN',
                     ...
                     'dir_output_standard_testpy':['Datasets_standard/Sample_Dataset_cyclegan/test'],
                     'dir_output_standard_inference':['Datasets_standard/Sample_Dataset_cyclegan/test_cli'],
